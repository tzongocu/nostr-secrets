  ...
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        ...
        direction === "right" && "inset-y-0 right-0 h-full w-full sm:max-w-md rounded-l-[10px]",
        className,
      )}
      {...props}
    >
      ...
      {showHandle && direction === "right" && (
        <div className="absolute left-2 top-1/2 -translate-y-1/2 h-[100px] w-2 rounded-full bg-muted" />
      )}
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
